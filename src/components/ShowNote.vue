            ...
            <ul class="flex justify-between">
                ...
                <li>
                    <ul class="flex gap-3 mr-1">
                        <li>
                            <svg @click="showEditForm = true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <li>
                            <svg @click="deleteNote(note)" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
