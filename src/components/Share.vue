...
<template>
    ...
    <div v-if="showShareDialog" class="fixed inset-0 grid place-items-center backdrop-blur backdrop-brightness-50">
        <div>
            <div class="bg-white/50 w-96 rounded-xl shadow-md p-5 flex flex-col gap-10 backdrop-blur-lg ">
                <div>
                    ...
                    <li title="Clipboard">
                        <button @click="copyToClipboard()">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="h-10">
                                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div v-if="showToast" class="fixed inset-x-0 bottom-2 flex justify-center">
        <div class="relative bg-white/50 px-5 shadow-md rounded-lg w-56 py-4">
